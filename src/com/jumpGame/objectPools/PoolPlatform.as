package com.jumpGame.objectPools
{
	...
	/**
	 * This class handles the Object Pooling for the platforms.
	 */
	public class PoolPlatform {
		...
		/** Objects in the pool. */
		private var list:Vector.<Platform> = new Vector.<Platform>();
		...
		public function PoolPlatform(create:Function, clean:Function = null, minSize:int = 50, maxSize:int = 200)
		{
			this.create = create;
			this.clean = clean;
		 ...
		 *
		 */
		public function checkOut():Platform
		{
			if(length == 0) {
				if(size < maxSize) {
					size++;
		 ...
		 *
		 */
		public function checkIn(item:Platform):void
		{
