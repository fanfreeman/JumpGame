package com.jumpGame.ui.components
{
	 ...
	 */
	public class MatchItemRenderer extends Button implements IListItemRenderer
	{
		/**
		 ...
		 * @private
		 */
		protected var _itemHasSublabel:Boolean = true;
		 ...
		 * @default true
		 */
		public function get itemHasSublabel():Boolean
		{
			return this._itemHasSublabel;
		}
		
		/**
		 * @private
		 */
		public function set itemHasSublabel(value:Boolean):void
		{
			if(this._itemHasSublabel == value)
			{
				return;
			}
			this._itemHasSublabel = value;
			this.invalidate(INVALIDATION_FLAG_DATA);
		}
		 ...
		 * @private
		 */
		protected var _sublabelField:String = "sublabel";
		 ...
		 * @see #labelFunction
		 */
		public function get sublabelField():String
		{
			return this._sublabelField;
		}
		
		/**
		 * @private
		 */
		public function set sublabelField(value:String):void
		{
			if(this._sublabelField == value)
			{
				return;
			}
			this._sublabelField = value;
			this.invalidate(INVALIDATION_FLAG_DATA);
		}
		 ...
		 * </ol>
		 */
		public function itemToSublabel(item:Object):String
		{
			if(this._sublabelField != null && item && item.hasOwnProperty(this._sublabelField))
			{
				var labelResult:Object = item[this._sublabelField];
				if(labelResult is String)
				{
					return labelResult as String;
				}
		...
		protected function commitData():void
		{
			if(this._owner)
			{
				...
				if(this.itemHasSublabel)
				{
					this._sublabel = this.itemToSublabel(this._data);
				}
