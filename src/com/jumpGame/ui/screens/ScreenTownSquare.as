package com.jumpGame.ui.screens
{
	...
	public class ScreenTownSquare extends Screen
	{
		...
		override protected function initialize():void
		{
			...
			var itemBg1:Image = new Image(Statics.assets.getTexture("TownItemBg0000"));
			var gap:Number = (wrapperWidth - itemBg1.width * 3) / 4; 
			itemBg1.x = Statics.stageWidth / 2 - wrapperWidth / 2 + gap;
			itemBg1.y = 80;
			this.addChild(itemBg1);
			
			var itemAchievements:Image = new Image(Statics.assets.getTexture("TownItemAchievements0000"));
			itemAchievements.x = itemBg1.x + 42;
			itemAchievements.y = itemBg1.y + 58;
			this.addChild(itemAchievements);
			
			// rankings image
			var itemBg2:Image = new Image(Statics.assets.getTexture("TownItemBg0000"));
			itemBg2.x = itemBg1.bounds.right + gap;
			itemBg2.y = itemBg1.y;
			this.addChild(itemBg2);
			
			var itemRankings:Image = new Image(Statics.assets.getTexture("TownItemRankings0000"));
			itemRankings.x = itemBg2.x + 37;
			itemRankings.y = itemBg2.y + 54;
			this.addChild(itemRankings);
			
			// my profile image
			var itemBg3:Image = new Image(Statics.assets.getTexture("TownItemBg0000"));
			itemBg3.x = itemBg2.bounds.right + gap;
			itemBg3.y = itemBg1.y;
			this.addChild(itemBg3);
			
			var itemProfile:Image = new Image(Statics.assets.getTexture("TownItemProfile0000"));
			...
			// images second row
			// characters image
			var itemBg4:Image = new Image(Statics.assets.getTexture("TownItemBg0000"));
			itemBg4.x = Statics.stageWidth / 2 - wrapperWidth / 2 + gap;
			itemBg4.y = itemBg1.bounds.bottom - 20;
			this.addChild(itemBg4);
			
			var itemCharacters:Image = new Image(Statics.assets.getTexture("TownItemCharacters0000"));
			itemCharacters.x = itemBg4.x + 42;
			itemCharacters.y = itemBg4.y + 48;
			this.addChild(itemCharacters);
			
			// get coins image
			var itemBg5:Image = new Image(Statics.assets.getTexture("TownItemBg0000"));
			itemBg5.x = itemBg4.bounds.right + gap;
			itemBg5.y = itemBg4.y;
			this.addChild(itemBg5);
			
			var itemCoins:Image = new Image(Statics.assets.getTexture("TownItemCoins0000"));
			itemCoins.x = itemBg5.x + 48;
			itemCoins.y = itemBg5.y + 63;
			this.addChild(itemCoins);
			
			// get gems image
			var itemBg6:Image = new Image(Statics.assets.getTexture("TownItemBg0000"));
			itemBg6.x = itemBg5.bounds.right + gap;
			itemBg6.y = itemBg4.y;
			this.addChild(itemBg6);
			
			var itemGems:Image = new Image(Statics.assets.getTexture("TownItemGems0000"));
			...
			btnAchievements.defaultSkin = new Image(Statics.assets.getTexture("TownItemButton0000"));
			btnAchievements.hoverSkin = new Image(Statics.assets.getTexture("TownItemButton0000"));
			btnAchievements.downSkin = new Image(Statics.assets.getTexture("TownItemButton0000"));
			...
			btnRankings.defaultSkin = new Image(Statics.assets.getTexture("TownItemButton0000"));
			btnRankings.hoverSkin = new Image(Statics.assets.getTexture("TownItemButton0000"));
			btnRankings.downSkin = new Image(Statics.assets.getTexture("TownItemButton0000"));
...
//			btnRankings.addEventListener(Event.TRIGGERED, Menu(this.owner).showRankingsScreen);
			...
			btnProfile.defaultSkin = new Image(Statics.assets.getTexture("TownItemButton0000"));
			btnProfile.hoverSkin = new Image(Statics.assets.getTexture("TownItemButton0000"));
			btnProfile.downSkin = new Image(Statics.assets.getTexture("TownItemButton0000"));
			...
			btnCharacters.defaultSkin = new Image(Statics.assets.getTexture("TownItemButton0000"));
			btnCharacters.hoverSkin = new Image(Statics.assets.getTexture("TownItemButton0000"));
			btnCharacters.downSkin = new Image(Statics.assets.getTexture("TownItemButton0000"));
			...
			btnGetCoins.defaultSkin = new Image(Statics.assets.getTexture("TownItemButton0000"));
			btnGetCoins.hoverSkin = new Image(Statics.assets.getTexture("TownItemButton0000"));
			btnGetCoins.downSkin = new Image(Statics.assets.getTexture("TownItemButton0000"));
			...
			btnGetGems.defaultSkin = new Image(Statics.assets.getTexture("TownItemButton0000"));
			btnGetGems.hoverSkin = new Image(Statics.assets.getTexture("TownItemButton0000"));
			btnGetGems.downSkin = new Image(Statics.assets.getTexture("TownItemButton0000"));
