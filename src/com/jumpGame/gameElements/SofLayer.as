package com.jumpGame.gameElements
{
	...
	public class SofLayer extends GameObject
	{
		...
		private function onAddedToStage(event:Event):void
		{
			...
			if (this.blurValue == 0) {
				waveAnim1 = new MovieClip(Statics.assets.getTextures("WaveBlur0"), 16);
				waveAnim2 = new MovieClip(Statics.assets.getTextures("WaveBlur0"), 16);
			}
			else if (this.blurValue == 1) {
				waveAnim1 = new MovieClip(Statics.assets.getTextures("WaveBlur1"), 16);
				waveAnim2 = new MovieClip(Statics.assets.getTextures("WaveBlur1"), 16);
			}
			else if (this.blurValue == 2) {
				waveAnim1 = new MovieClip(Statics.assets.getTextures("WaveBlur2"), 16);
				waveAnim2 = new MovieClip(Statics.assets.getTextures("WaveBlur2"), 16);
			}
